module.exports = function (plop) {
  plop.setGenerator('page', {
    ...
    actions: [
      {
        type: 'add',
        path: 'src/pages/{{camelCase pageName}}/functions/index.ts',
        templateFile: 'src/infra/templates/functions/index.hbs',
      },
      {
        type: 'add',
        path: 'src/pages/{{camelCase pageName}}/hooks/index.tsx',
        templateFile: 'src/infra/templates/hooks/index.hbs',
      },
      {
        type: 'add',
        path: 'src/pages/{{camelCase pageName}}/template/index.tsx',
        templateFile: 'src/infra/templates/template/template.hbs',
      },
      {
        type: 'add',
        path: 'src/pages/{{camelCase pageName}}/template/components/index.tsx',
        templateFile: 'src/infra/templates/template/components/index.hbs',
      },
      {
        type: 'add',
        path: 'src/pages/{{camelCase pageName}}/index.tsx',
        templateFile: 'src/infra/templates/index.hbs',
      },
      {
        type: 'add',
        path: 'src/pages/{{camelCase pageName}}/mocks/TableColumns.tsx',
        templateFile: 'src/infra/templates/mocks/index.hbs',
      },
      {
        type: 'add',
        path: 'src/domain/{{camelCase pageName}}/models/index.ts',
        templateFile: 'src/infra/templates/domain/models/index.hbs',
      },
      {
        type: 'add',
        path: 'src/domain/{{camelCase pageName}}/services/{{camelCase pageName}}.useCases.ts',
        templateFile: 'src/infra/templates/domain/services/service.useCases.hbs',
      },
      {
        type: 'add',
        path: 'src/domain/{{camelCase pageName}}/index.ts',
